...
def open_cam_rtsp(uri, latency=200):
	# gst_str = ("rtspsrc location={} latency={} ! queue ! rtph264depay ! h264parse ! queue ! h264parse ! omxh264dec ! videoconvert ! appsink").format(uri, latency)
...
if __name__ == '__main__':
    ...
    if args.rtsp != 0:
        ...
        cap = open_cam_rtsp(input_path,200)
    else:
        input_path = str2int(args.input)
